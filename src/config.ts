...
const configSchema = z.object({
  NEXT_PUBLIC_URL: z.string().default("https://lalalycheee.vn"),
  NEXT_PUBLIC_API_END_POINT: z.string().default("https://api.lalalycheee.vn"),
  NEXT_PUBLIC_URL_LOGO: z.string().default("https://placehold.co/200x80"),
  NEXT_PUBLIC_BACKEND_URL: z.string().default("https://api.lalalycheee.vn"),
  NEXT_PUBLIC_API_VERSION: z.string().default("v1"),
  // Production flag - set to true when deploying
  NEXT_PUBLIC_IS_PRODUCTION: z.string().default("true"),
});
...
if (!config.success) {
  ...
  // Use production values as default for deployment
  envConfig = {
    NEXT_PUBLIC_URL: "https://lalalycheee.vn",
    NEXT_PUBLIC_API_END_POINT: "https://api.lalalycheee.vn",
    NEXT_PUBLIC_URL_LOGO: "https://placehold.co/200x80",
    NEXT_PUBLIC_BACKEND_URL: "https://api.lalalycheee.vn",
    NEXT_PUBLIC_API_VERSION: "v1",
    NEXT_PUBLIC_IS_PRODUCTION: "true",
  };
  console.log("Using production config:", envConfig);
} else {
  // Force production URLs regardless of environment variables
  envConfig = {
    ...config.data,
    NEXT_PUBLIC_API_END_POINT: "https://api.lalalycheee.vn",
    NEXT_PUBLIC_BACKEND_URL: "https://api.lalalycheee.vn",

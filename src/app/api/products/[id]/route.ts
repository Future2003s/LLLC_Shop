...
export async function PUT(
  ...
  try {
    ...
    if (!cleanBody.status || cleanBody.status === "") {
      cleanBody.status = "draft";
      console.log("Fixed empty status to 'draft'");
    }
    ...
    // Never allow client to send createdBy/updatedBy/id fields
    [
      "createdBy",
      "updatedBy",
      "_id",
